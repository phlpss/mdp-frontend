    ...
    attributes: [
      ...
      { id: 'role',        name: 'role',        label: 'Role',         fieldType: 'enum',     required: true,  sensitive: false, sortable: true,  filterable: true,  showInList: true,  showInForm: true,  readOnly: false, order: 5,
        enumValues: [
          ...
          { value: 'STORE_MANAGER',  label: 'Store Manager',  color: '#1a237e' },
          { value: 'SUPERVISOR',     label: 'Supervisor',     color: '#388e3c' },
          { value: 'HR',             label: 'HR',             color: '#7b1fa2' },
          { value: 'HR_MANAGER',     label: 'HR Manager',     color: '#4a148c' },
          { value: 'ACCOUNTANT',     label: 'Accountant',     color: '#f57c00' },
          { value: 'OWNER',          label: 'Owner',          color: '#880e4f' },
          { value: 'BUSINESS_OWNER', label: 'Business Owner', color: '#b71c1c' },
          { value: 'IT_SPECIALIST',  label: 'IT Specialist',  color: '#006064' },
          { value: 'SHIFT_SUPERVISOR',  label: 'Shift Supervisor',  color: '#006064' },
        ]
      },
